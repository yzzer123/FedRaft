...
public final class JobManagerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.bupt.fedraft.rpc.jobmanager.message.AppendModelsRequest,
      org.bupt.fedraft.rpc.jobmanager.message.AppendModelsResponse> getAppendModelsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AppendModels",
      requestType = org.bupt.fedraft.rpc.jobmanager.message.AppendModelsRequest.class,
      responseType = org.bupt.fedraft.rpc.jobmanager.message.AppendModelsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.bupt.fedraft.rpc.jobmanager.message.AppendModelsRequest,
      org.bupt.fedraft.rpc.jobmanager.message.AppendModelsResponse> getAppendModelsMethod() {
    io.grpc.MethodDescriptor<org.bupt.fedraft.rpc.jobmanager.message.AppendModelsRequest, org.bupt.fedraft.rpc.jobmanager.message.AppendModelsResponse> getAppendModelsMethod;
      ...
      synchronized (JobManagerServiceGrpc.class) {
        if ((getAppendModelsMethod = JobManagerServiceGrpc.getAppendModelsMethod) == null) {
          JobManagerServiceGrpc.getAppendModelsMethod = getAppendModelsMethod =
              io.grpc.MethodDescriptor.<org.bupt.fedraft.rpc.jobmanager.message.AppendModelsRequest, org.bupt.fedraft.rpc.jobmanager.message.AppendModelsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AppendModels"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.bupt.fedraft.rpc.jobmanager.message.AppendModelsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.bupt.fedraft.rpc.jobmanager.message.AppendModelsResponse.getDefaultInstance()))
  ...
  public static abstract class JobManagerServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void appendModels(org.bupt.fedraft.rpc.jobmanager.message.AppendModelsRequest request,
        io.grpc.stub.StreamObserver<org.bupt.fedraft.rpc.jobmanager.message.AppendModelsResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                org.bupt.fedraft.rpc.jobmanager.message.AppendModelsRequest,
                org.bupt.fedraft.rpc.jobmanager.message.AppendModelsResponse>(
  ...
  public static final class JobManagerServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<JobManagerServiceBlockingStub> {
    ...
    /**
     */
    public org.bupt.fedraft.rpc.jobmanager.message.AppendModelsResponse appendModels(org.bupt.fedraft.rpc.jobmanager.message.AppendModelsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class JobManagerServiceFutureStub extends io.grpc.stub.AbstractFutureStub<JobManagerServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.bupt.fedraft.rpc.jobmanager.message.AppendModelsResponse> appendModels(
        org.bupt.fedraft.rpc.jobmanager.message.AppendModelsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_APPEND_MODELS:
          serviceImpl.appendModels((org.bupt.fedraft.rpc.jobmanager.message.AppendModelsRequest) request,
              (io.grpc.stub.StreamObserver<org.bupt.fedraft.rpc.jobmanager.message.AppendModelsResponse>) responseObserver);
          break;
